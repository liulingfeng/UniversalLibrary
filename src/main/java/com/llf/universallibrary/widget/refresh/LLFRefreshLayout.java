...
import static com.llf.universallibrary.R.styleable.TwinklingRefreshLayout;
...
public class LLFRefreshLayout extends FrameLayout {
    ...
    public LLFRefreshLayout(Context context) {
        this(context, null, 0);
    }

    public LLFRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LLFRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();

        TypedArray a = context.obtainStyledAttributes(attrs, TwinklingRefreshLayout, defStyleAttr, 0);
        mWaveHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_wave_height, SettingUtil.dip2px(context, 120));
        mHeadHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_head_height, SettingUtil.dip2px(context, 80));
        mBottomHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_bottom_height, SettingUtil.dip2px(context, 60));
        mOverScrollHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_overscroll_height, SettingUtil.dip2px(context, 80));
                ...
                if (state == PULL_DOWN_REFRESH) {
                    ...
                    if (mChildView != null) {
                        ...
                        if (pullListener != null) {
                            pullListener.onPullingDown(LLFRefreshLayout.this, offsetY / mHeadHeight);
                        }
                    }
                    ...
                    if (mChildView != null) {
                        ...
                        if (pullListener != null) {
                            pullListener.onPullingUp(LLFRefreshLayout.this, offsetY / mHeadHeight);
                        }
                    }
                }
                return true;
                ...
                if (mChildView != null) {
                    if (state == PULL_DOWN_REFRESH) {
                        if (!isPureScrollModeOn && mChildView.getTranslationY() >= mHeadHeight - mTouchSlop) {
                            ...
                            isRefreshing = true;
                            if (pullListener != null) {
                                pullListener.onRefresh(LLFRefreshLayout.this);
                            }
                        } else {
                            animChildView(0f);
                        }
                        ...
                        if (!isPureScrollModeOn && Math.abs(mChildView.getTranslationY()) >= mBottomHeight - mTouchSlop) {
                            ...
                            if (pullListener != null) {
                                pullListener.onLoadMore(LLFRefreshLayout.this);
                            }
                        } else {
                            animChildView(0f);
                        }
        ...
        oa.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (state == PULL_DOWN_REFRESH) {
                    ...
                    if (pullListener != null) {
                        pullListener.onPullDownReleasing(LLFRefreshLayout.this, height / mHeadHeight);
                    }
                } else if (state == PULL_UP_LOAD) {
                    ...
                    if (pullListener != null) {
                        pullListener.onPullUpReleasing(LLFRefreshLayout.this, height / mBottomHeight);
                    }
                }
            }
        });
    ...
    public interface PullListener {
         ...
         * @param fraction
         */
        void onPullingDown(LLFRefreshLayout refreshLayout, float fraction);

        /**
         * 上拉
         */
        void onPullingUp(LLFRefreshLayout refreshLayout, float fraction);
         ...
         * @param fraction
         */
        void onPullDownReleasing(LLFRefreshLayout refreshLayout, float fraction);

        /**
         * 上拉松开
         */
        void onPullUpReleasing(LLFRefreshLayout refreshLayout, float fraction);

        /**
         * 刷新中。。。
         */
        void onRefresh(LLFRefreshLayout refreshLayout);

        /**
         * 加载更多中
         */
        void onLoadMore(LLFRefreshLayout refreshLayout);
    ...
    private class SimplePullListener implements PullListener {
        ...
        @Override
        public void onPullingDown(LLFRefreshLayout refreshLayout, float fraction) {
        ...
        @Override
        public void onPullingUp(LLFRefreshLayout refreshLayout, float fraction) {
        ...
        @Override
        public void onPullDownReleasing(LLFRefreshLayout refreshLayout, float fraction) {
        ...
        @Override
        public void onPullUpReleasing(LLFRefreshLayout refreshLayout, float fraction) {
